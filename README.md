...
| [noVNC Clipboard Bridge](https://raw.githubusercontent.com/jeeftor/userScripts/master/scripts/novnc-clipboard-bridge/novnc-clipboard-bridge.user.js) | [raw](https://raw.githubusercontent.com/jeeftor/userScripts/master/scripts/novnc-clipboard-bridge/novnc-clipboard-bridge.user.js) | [`scripts/novnc-clipboard-bridge`](scripts/novnc-clipboard-bridge/) | Floating paste/copy buttons to bridge local and remote clipboard in noVNC sessions. |
| [ttyd Shift+Enter Newline](https://raw.githubusercontent.com/jeeftor/userScripts/master/scripts/ttyd-shift-enter/ttyd-shift-enter.user.js) | [raw](https://raw.githubusercontent.com/jeeftor/userScripts/master/scripts/ttyd-shift-enter/ttyd-shift-enter.user.js) | [`scripts/ttyd-shift-enter`](scripts/ttyd-shift-enter/) | Send a literal newline (not execute) when Shift+Enter is pressed in ttyd/xterm.js. |
